...
class DwSubmissionregDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'dwsubmissions.dw_submissionregs.datatables_actions')
            ->make(true);
    }
    ...
    {
        $dwSubmissionregs = DwSubmissionreg::query();

        return $this->applyScopes($dwSubmissionregs);
    }
