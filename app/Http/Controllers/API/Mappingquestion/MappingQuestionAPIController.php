...
namespace App\Http\Controllers\API\Mappingquestion;

use App\Http\Requests\API\Mappingquestion\CreateMappingQuestionAPIRequest;
use App\Http\Requests\API\Mappingquestion\UpdateMappingQuestionAPIRequest;
