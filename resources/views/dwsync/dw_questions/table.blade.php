    ...
    @foreach($dwQuestions as $dwQuestion)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('dwsync.dwQuestions.show', [$dwQuestion->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('dwsync.dwQuestions.edit', [$dwQuestion->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
