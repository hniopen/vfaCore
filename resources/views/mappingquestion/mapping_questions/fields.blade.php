...
<div class="form-group col-sm-6">
    {!! Form::label('mappingProjectId', 'Mappingprojectid:') !!}
    {!! Form::number('mappingProjectId', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('mappingquestion.mappingQuestions.index') !!}" class="btn btn-default">Cancel</a>
</div>
