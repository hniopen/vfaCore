...
class CreateDwSubmissionvilsTable extends Migration
{
    ...
    public function up()
    {
        Schema::dropIfExists('dw_submissionvils');
        Schema::create('dw_submissionvils', function (Blueprint $table) {
            $table->increments('id');
