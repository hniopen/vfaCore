...
class CreateDwSubmission172sTable extends Migration
{
    ...
    public function up()
    {
        Schema::dropIfExists('dw_submission172s');
        Schema::create('dw_submission172s', function (Blueprint $table) {
            $table->increments('id');
