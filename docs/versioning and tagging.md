# Guide for versioning & tagging
This is a good guide for how to do versioning in [https://semver.org/](https://semver.org/).
We we can use that for tags too. Every tag should be **working** but branches can be a work **in progress**.
And then it would make sense to lock repo to a tag which works.
